      ...
      <div class="accordion">
        ...
        <div class="hidden-box">
          <p class="text">
            ...
            amet consectetur adipisicing elit. Incidunt mollitia iste id
            quisquam epudiandae assumenda eius doloribus.
          </p>
          <ul>
      ...
      <div class="accordion">
        ...
        <div class="hidden-box">
          <p class="text">
            ...
            expedita quos laudantium culpa sed voluptas.
          </p>
          <ul>
            <li>Lorem ipsum dolor sit amet consectetur adipisicing elit.</li>
            <li>Lorem ipsum, dolor sit amet consectetur adipisicing elit.</li>
      ...
      <div class="container">
        <div class="cta">
          <div class="cta-text-box">
            ...
            <form action = "Registration_second.html" method = "post">

              <div class = "explore_more">
              <button class="btnm btn--formm">Register Now</button></div>
      ...
      <div class="Main_footer">
        <div class="Foot_logo">
          ...
          <div class="foot_button">
            <div class="button">
              <button type="Get News">Subscribe</button>
            </div>
          </div>
        </div>
        <div class="foot_1">
          <ul>
            <li class="head_1"><b>Partnership</b></li>
            <li class="head_2">Intel</li>
            <li class="head_2">Panasonic</li>
            <li class="head_2">SamSung</li>
            <li class="head_2">Coca-Cola</li>
          </ul>
        </div>
        <div class="foot_1">
          <ul>
            <li class="head_1"><b>About Us</b></li>
            <li class="head_2">Athletes</li>
            <li class="head_2">Sports</li>
            <li class="head_2">Live Events</li>
            <li class="head_2">News</li>
          </ul>
        </div>
        <div class="foot_1">
          <li class="head_1"><b>Contact Us</b></li>
          <li class="head_2">E-mail</li>
          <li class="head_2">Toll-Free Contact</li>
        </div>
      </div>
    </footer> -->
